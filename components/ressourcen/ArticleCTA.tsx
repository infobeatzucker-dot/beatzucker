  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          {lang === "de"
            ? "UpMaDo mastert deinen Track in Sekunden — KI-gestützt, plattformoptimiert, kostenlos starten."
            : "UpMaDo masters your track in seconds — AI-powered, platform-optimized, free to start."}
        </p>
